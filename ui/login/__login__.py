...
from __model__ import userLogin, userRegister
...
class LoginDesigner(QMainWindow, Ui_systemClass):
    ...
    def button_init(self):
        ...
        self.buttonLogin.clicked.connect(userLogin)  # 登录按钮点击信号绑定槽函数
        self.buttonRegister.clicked.connect(userRegister)  # 注册按钮点击信号绑定槽函数
