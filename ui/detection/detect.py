...
python yolov5/detect.py --weights yolov5/weights/yolov5n.pt --source rtsp://admin:123456@192.168.31.46:3389/stream0
...
class DetectThread(QThread):
    ...
    def __init__(self, parent=None, p_source=None):
...
#                         help='model path(s)')
#     parser.add_argument('--source', type=str, default=detect_source,
